...
const stationInfo = {
  [strand]:
    '<img src="images/ef1f442c-24bf-40c8-a82b-e89b71c66ecf_3000.jpg" onclick="this.requestFullscreen()" class="center" title="View of the Grand Canal" width="400"> (c1743) by Bernardo Bellotto. <br><br> From the <a href=\'https://www.getty.edu/art/collection/object/103RJP#full-artwork-details\'>Getty\'s Collection Online</a>.',
  [down]:
    '<img src="images/ef390b6c-6021-4738-92fe-2338c38cc2af_3000.jpg" onclick="this.requestFullscreen()" class="center" title="A View of Paris with the Ile de la Cité" width="400"> (c1763) by Jean-Baptiste Raguenet. <br><br> From the <a href=\'https://www.getty.edu/art/collection/object/103RBA\'>Getty\'s Collection Online</a>.',
  [museum]:
  ...
  [william]:
    '<img src="images/argenteuil_1970.17.42.jpg" onclick="this.requestFullscreen()" class="center" title="Argenteuil" width="400"> (1872) by Claude Monet. <br><br> From the <a href=\'https://www.nga.gov/collection/art-object-page.52186.html\'>National Gallery of Art</a>.',
  [mark]:
  ...
  [five]:
    '<img src="images/DP265419.jpg" onclick="this.requestFullscreen()" class="center" title="The Five Points, New York around 1827" width="400"> (c1827) by Unknown. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/20891\'>Met Museum</a>.',
  [granada]:
    '<img src="images/DP226882.jpg" onclick="this.requestFullscreen()" class="center" title="The Hill of the Alhambra, Granada" width="400"> (1865) by Samuel Colman. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/10508\'>Met Museum</a>.',
  [bruton]:
    '<img src="images/DT207462.jpg" onclick="this.requestFullscreen()" class="center" title="Old Bruton Church, Williamsburg, Virginia" width="400"> (1893) by Alfred Thompson. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/12796\'>Met Museum</a>.',
  [warwick]:
    '<img src="images/Wrightsman21.jpg" onclick="this.requestFullscreen()" class="center" title="Warwick Castle" width="400"> (1748) by Canaletto. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/438106\'>Met Museum</a>.',
  [huis]:
    '<img src="images/DP145409.jpg" onclick="this.requestFullscreen()" class="center" title="The Huis ten Bosch at The Hague and Its Formal Garden" width="400"> (c1669) by Jan van der Heyden. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/436648\'>Met Museum</a>.',
  [washington]:
    '<img src="images/DT2023.jpg" onclick="this.requestFullscreen()" class="center" title="Seventh Regiment on Review, Washington Square, New York" width="400"> (c1851) by Otto Boetticher. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/10194\'>Met Museum</a>.',
  [molo]:
    '<img src="images/DT3064.jpg" onclick="this.requestFullscreen()" class="center" title="The Molo, Venice, Looking West" width="400"> (1709) by Luca Carlevaris. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/459032\'>Met Museum</a>.',
  [porte]:
    '<img src="images/DP-19017-001.jpg" onclick="this.requestFullscreen()" class="center" title="Portejoie on the Seine" width="400"> (1858-1868) by Charles-François Daubigny. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/436088\'>Met Museum</a>.',
  [matterhorn]:
    '<img src="images/DT218107.jpg" onclick="this.requestFullscreen()" class="center" title="Sunrise on the Matterhorn" width="400"> (1875) by Albert Bierstadt. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/10158\'>Met Museum</a>.',
  [center]:
    '<img src="images/1845_3_1_l.jpg" onclick="this.requestFullscreen()" class="center" title="Fourth of July in Centre Square, Philadelphia" width="400"> (1812) by John L. Krimmel. <br><br> From the <a href=\'https://www.pafa.org/museum/collection/item/fourth-july-centre-square\'>Pennsylvania Academy of the Fine Arts</a>.',
  [reine]:
    '<img src="images/DP-17243-001.jpg" onclick="this.requestFullscreen()" class="center" title="Porte de la Reine at Aigues-Mortes" width="400"> (1867) by Jean-Frédéric Bazille. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/435626\'>Met Museum</a>.',
  [stage]:
    '<img src="images/DT5586.jpg" onclick="this.requestFullscreen()" class="center" title="Stage Fort across Gloucester Harbor" width="400"> (1862) by Fitz Henry Lane. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/11396\'>Met Museum</a>.',
  [berlin]:
    '<img src="images/DP157664.jpg" onclick="this.requestFullscreen()" class="center" title="Parochialstrasse in Berlin" width="400"> (1831) by Eduard Gaertner. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/438848\'>Met Museum</a>.',
  [rialto]:
    '<img src="images/DP124053.jpg" onclick="this.requestFullscreen()" class="center" title="The Grand Canal above the Rialto" width="400"> (1760-1770) by Francesco Guardi. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/436599\'>Met Museum</a>.',
  [lady]:
    '<img src="images/ycba_c51ed4fd-f6ab-41aa-9ce3-39354305c1fe.jpg" onclick="this.requestFullscreen()" class="center" title="Church of Notre Dame, Bruges" width="400"> (c1820) by Samuel Austin. <br><br> From the <a href=\'https://collections.britishart.yale.edu/catalog/tms:13052\'>Yale Center for British Art</a>.',
  [ely]:
  ...
  [teatro]:
    '<img src="images/the_roman_theater_at_taormina_2004.166.33.jpg" onclick="this.requestFullscreen()" class="center" title="The Roman Theater at Taormina" width="400"> (1828) by Louise-Joséphine Sarazin de Belmont. <br><br> From the <a href=\'https://www.nga.gov/collection/art-object-page.130896.html\'>National Gallery of Art</a>.',
  [taj]:
    '<img src="images/the_taj_mahal_1978.80.3.jpg" onclick="this.requestFullscreen()" class="center" title="The Taj Mahal" width="400"> (1860-80) by Erastus Salisbury Field. <br><br> From the <a href=\'https://www.nga.gov/collection/art-object-page.56730.html\'>National Gallery of Art</a>.',
  [capitol]:
    '<img src="images/emancipation_proclamation_1955.11.10.jpg" onclick="this.requestFullscreen()" class="center" title="Emancipation Proclamation" width="400"> (1864) by A.A. Lamb. <br><br> From the <a href=\'https://www.nga.gov/collection/art-object-page.43441.html\'>National Gallery of Art</a>.',
  [marly]:
  ...
  [tour]:
    '<img src="images/download.png" onclick="this.requestFullscreen()" class="center" title="Tour de Montelban, Amsterdam" width="400"> (1884) by Maxime Lalanne. <br><br> From the <a href=\'https://www.clevelandart.org/art/1998.365\'>Cleveland Museum of Art</a>.',
  [rouen]:
  ...
  [coto]:
    '<img src="images/SAAM-1965.12_2-000001_screen.jpg" onclick="this.requestFullscreen()" class="center" title="Cotopaxi" width="400"> (1855) by Frederic Edwin Church. <br><br> From the <a href=\'https://americanart.si.edu/artwork/cotopaxi-4807\'>Smithsonian</a>.',
  [antwerp]:
    '<img src="images/SAAM-1962.13.8_1_screen.jpg" onclick="this.requestFullscreen()" class="center" title="Antwerp Cathedral" width="400"> (1899) by Cass Gilbert. <br><br> From the <a href=\'https://americanart.si.edu/artwork/antwerp-cathedral-9010\'>Smithsonian</a>.',
  [windsor]:
    '<img src="images/ma-312377.jpg" onclick="this.requestFullscreen()" class="center" title="View of Windsor Castle" width="400"> (1863) by Edward Moran. <br><br> From the <a href=\'https://collections.lacma.org/node/2157735\'>Los Angeles County Museum of Art</a>.',
  [rock]:
    '<img src="images/SAAM-2011.43_1.jpg" onclick="this.requestFullscreen()" class="center" title="Clearing Storm at Gibraltar" width="400"> (1860) by Samuel Colman. <br><br> From the <a href=\'https://americanart.si.edu/artwork/clearing-storm-gibraltar-81938\'>Smithsonian</a>.',
  [florence]:
    '<img src="images/SAAM-1983.83.154_1_screen.jpg" class="center" title="Ponte Vecchio, Florence" width="400"> (1900) by George Elbert Burr. <br><br> From the <a href=\'https://americanart.si.edu/artwork/ponte-vecchio-florence-3276\'>Smithsonian</a>.',
  [custom]:
    '<img src="images/DP115732.jpg" class="center" title="The Custom House at Greenock, Scotland" width="400"> (1828) by Robert Salmon. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/12024\'>Met Museum</a>.',
  [brooklyn]:
    '<img src="images/ap36.123.1.jpg" class="center" title="Vechte House at Gowannus, Brooklyn, New York" width="400"> (1865) by Unknown. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/13015\'>Met Museum</a>.',
  [alkmaar]:
    '<img src="images/DP145944.jpg" class="center" title="View of the Town of Alkmaar" width="400"> (1620-70) by Salomon van Ruysdael. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/437590\'>Met Museum</a>.',
  [ghent]:
    '<img src="images/DAC_1984-29-113_001_OA.jpg" class="center" title="Ghent Gate, Bruges" width="400"> (1898) by William Strang. <br><br> From the <a href=\'https://dac-collection.wesleyan.edu/objects-1/info/13179\'>Davison Art Center</a>.',
  [golden]:
    '<img src="images/ycba_a56bcc91-8fed-4764-a6b0-8b50b24c017d.jpg" class="center" title="High Street, Edinburgh" width="400"> (1818) by Joseph Mallord William Turner. <br><br> From the <a href=\'https://collections.britishart.yale.edu/catalog/tms:5501\'>Yale Center for British Art</a>.',
  [ruins]:
  ...
  [old]:
    '<img src="images/DT218025.jpg" class="center" title="Old Annapolis, Francis Street" width="400"> (1876) by Francis Blackwell Mayer. <br><br> From the <a href=\'https://www.metmuseum.org/art/collection/search/11524\'>Met Museum</a>.',
  [founding]:
    '<img src="images/a128112h.jpg" class="center" title="Founding of Australia, Sydney Cove" width="400"> (1937) by Algernon Talmage. <br><br> From the <a href=\'https://www.sl.nsw.gov.au/collection-items/founding-australia-capt-arthur-phillip-rn-sydney-cove-jan-26th-1788\'>State Library NSW</a>.',
  [compton]:
    '<img src="images/SAAM-1962.13.62_1.jpg" class="center" title="Compton Castle, Devonshire, England" width="400"> (1928) by Cass Gilbert. <br><br> From the <a href=\'https://americanart.si.edu/artwork/compton-castle-devonshire-england-9031\'>Smithsonian</a>.',
  [eichhorn]:
  ...
  [bright]:
    '<img src="images/Bright_Light_at_Russell\'s_Corners_by_George_Ault_(1946).jpg" class="center" title="Bright Light at Russells Corners" width="400"> (1958) by George Ault. <br><br> From the <a href=\'https://www.si.edu/object/bright-light-russells-corners:saam_1976.121\'>Smithsonian</a>.',
  [oxford]:
    '<img src="images/ycba_bc3c66ce-4a77-40c2-b77f-85870cf8272b.jpg" class="center" title="A View of St. Mary\'s Church, Oxford" width="400"> (c1760) by John Donowell. <br><br> From the <a href=\'https://collections.britishart.yale.edu/catalog/tms:4554\'>Yale Center for British Art</a>.',
  [prague]:
    '<img src="images/533089ldsdl.jpg" class="center" title="Charles Bridge in Prague" width="400"> (20th Century) by René Leclercq. <br><br> From the <a href=\'https://vlaamsekunstcollectie.be/en/collection/2595\'>Flemish Art Collection</a>.',
  [bayisland]:
    '<img src="images/536736ldsdl.jpg" class="center" title="Kororareka Beach, Bay of Islands, New Zealand" width="400"> (c1856) by Thomas Gardiner. <br><br> From the <a href=\'https://collections.tepapa.govt.nz/object/41571\'>Museum of New Zealand</a>.',
  [rathaus]:
    '<img src="images/1280px-Rudolf_von_Alt_-_Das_Rathaus_in_Gmunden_-_988_-_%C3%96sterreichische_Galerie_Belvedere.jpg" class="center" title="Das Rathaus in Gmunden" width="400"> (1860) by Rudolf von Alt. <br><br> From the <a href=\'https://sammlung.belvedere.at/objects/6770/das-rathaus-in-gmunden?\'>Belvedere Gallery, Austria</a>.',
  [damplatz]:
  ...
  [spui]:
    '<img src="images/522659ldsdl.jpg" class="center" title="The so-called Boerenverdriet on the Spui, Amsterdam" width="400"> (1750-81) by Jan Ekels <br><br> From the <a href=\'https://www.rijksmuseum.nl/en/collection/SK-A-3475\'>Rijksmuseum</a>.',
  [caer]:
    '<img src="images/523825ldsdl.jpg" class="center" title="Landscape with ships in front of Caernarvon Castle" width="400"> (1883) by William Callow <br><br> From the <a href=\'https://www.rijksmuseum.nl/nl/collectie/RP-T-1978-4\'>Rijksmuseum</a>.',
  [bow]:
    '<img src="images/529900ldsdl.jpg" class="center" title="Street Scene at Stratford by Bow" width="400"> (c1850) by Thomas Shotter Boys <br><br> From the <a href=\'https://collections.britishart.yale.edu/catalog/tms:12506\'>Yale Center for British Art</a>.',
  [quila]:
  ...
  [spinner]:
    '<img src="images/Spinnerin_am_Kreuz_1831.jpg" class="center" title="Die Spinnerin am Kreuz mit Aussicht gegen das Mödlinger Gebirge" width="400"> (1831) by Franz Scheyerer <br><br> From the <a href=\'https://sammlung.wienmuseum.at/en/object/129254-die-spinnerin-am-kreuz-mit-aussicht-gegen-das-moedlinger-gebirge/\'>Wein Museum</a>.',
  [grote]:
    '<img src="images/524647ldsdl.jpg" class="center" title="Street Scene in Beverwijk" width="400"> (1793) by Jacob Cats <br><br> From the <a href=\'https://www.rijksmuseum.nl/nl/collectie/RP-T-1964-58\'>Rijksmuseum</a>.',
  [harf]:
    '<img src="images/540933ldsdl.jpg" class="center" title="Harfleur near Le Havre (view of Saint Martin)" width="400"> (1836) by Johann Wilhelm Schirmer <br><br> From the <a href=\'https://www.kunsthalle-karlsruhe.de/kunstwerke/Johann-Wilhelm-Schirmer/Harfleur-bei-Le-Havre--Blick-auf-Saint-Martin/17CA36184EC0CEB5E0B20A8EB7AD7C9D/\'>Staatliche Kunsthalle Karlsruhe</a>.',
  [oude]:
    '<img src="images/0868_repro.jpg" class="center" title="View of Oudezijds Voorburgwal with the Oude Kerk in Amsterdam" width="400"> (1670) by Jan van der Heyden <br><br> From the <a href=\'https://www.mauritshuis.nl/en/our-collection/artworks/868-view-of-oudezijds-voorburgwal-with-the-oude-kerk-in-amsterdam/\'>Mauritshuis</a>.',
  [christ]:
    '<img src="images/canterbury.jpg" class="center" title="Christ Church Gate, Canterbury" width="400"> (1793) by J. M. W. Turner <br><br> From the <a href=\'https://collections.britishart.yale.edu/catalog/tms:2135\'>Yale Center for British Art</a>.',
  [pope]:
    '<img src="images/pope.jpg" class="center" title="A View of Alexander Pope\'s Villa, Twickenham, on the Banks of the Thames" width="400"> (1759) by Samuel Scott  <br><br> From the <a href=\'https://www.denverartmuseum.org/en\'>Denver Art Museum</a>.',
  [bavo]:
    '<img src="images/535937ldsdl.jpg" class="center" title="St Bavo’s Cathedral and the Reep in Ghent" width="400"> (1831) by Pieter-Frans De Noter  <br><br> From the <a href=\'https://www.mskgent.be/en/collection/1975-U\'>Museum of Fine Arts Ghent</a>.',
  [bogor]:
    '<img src="images/523056ldsdl.jpg" class="center" title="Rear View of Buitenzorg Palace before the Earthquake of 10 October 1834" width="400"> (1834) by Willem Troost the younger <br><br> From the <a href=\'https://www.rijksmuseum.nl/en/collection/SK-A-4024\'>Rijksmusuem</a>.',
  [harm]:
    '<img src="images/524700ldsdl.jpg" class="center" title="View in the village of Harmelen" width="400"> (1749) by Jan de Beijer <br><br> From the <a href=\'https://www.rijksmuseum.nl/nl/collectie/RP-T-1890-A-2264\'>Rijksmusuem</a>.',
  [doge]:
    '<img src="images/515581ldsdl.jpg" class="center" title="Courtyard of the Doge\'s Palace" width="400"> (1810) by Tranquillo Orsi <br><br> From the <a href=\'https://www.khm.at/\'>Kunsthistorisches Museum</a>.',
  [durham]:
  ...
  [lincoln]:
    '<img src="images/lincoln.jpg" class="center" title="A View of the Cathedral and City of Lincoln from the River" width="400"> (1760) by Joseph Baker of Lincoln <br><br> From the <a href=\'https://collections.britishart.yale.edu/catalog/tms:364\'>Yale Center for British Art</a>.',
  [pantheon]:
    '<img src="images/508157ldsdl.jpg" class="center" title="The Pantheon" width="400"> (c1800) by Victor Jean Nicolle  <br><br> From the <a href=\'https://www.nga.gov/collection/art-object-page.143894.html\'>National Gallery of Art</a>.',
  [singel]:
    '<img src="images/522462ldsdl.jpg" class="center" title="The Singel Bridge at the Paleisstraat in Amsterdam" width="400"> (1898) by George Hendrik Breitner  <br><br> From the <a href=\'https://www.rijksmuseum.nl/en/collection/SK-A-3580\'>Rijksmuseum</a>.',
  [moret]:
    '<img src="images/508369ldsdl.jpg" class="center" title="Le Pont de Moret" width="400"> (1888) by Alfred Sisley <br><br> From the <a href=\'https://collections.artsmia.org/art/61319/le-pont-de-moret-alfred-sisley\'>Minneapolis Institute of Art</a>.',
  [briar]:
    '<img src="images/Henri-Joseph_Harpignies_-_The_Railroad_Bridge_at_Briare_-_Google_Art_Project.jpg" class="center" title="The Railroad Bridge at Briare" width="400"> (c1900) by Joseph Harpignies <br><br> From the <a href=\'https://philbrook.org/\'>Philbrook Museum of Art</a>.',
  [rotund]:
    '<img src="images/542009ldsdl.jpg" class="center" title="At Barrière de la Villette, Paris" width="400"> (1823) by Auguste Xavier Leprince <br><br> From the <a href=\'https://collection.nationalmuseum.se/eMP/eMuseumPlus?service=ExternalInterface&module=collection&objectId=181922&viewType=detailView\'>Nationalmuseum</a>.',
  [bocca]:
    '<img src="images/503938ldsdl.jpg" class="center" title="Piazza della Bocca della Verità with the so-called Vesta Temple in Rome" width="400"> (1837) by Constantin Hansen <br><br> From the <a href=\'https://open.smk.dk/artwork/image/kms1072\'>Statens Museum for Kunst</a>.',
  [port]:
    '<img src="images/port.jpeg" class="center" title="The Harbor of Granatello near Portici with Vesuvius in the background" width="400"> (1819) by Joseph Rebell <br><br> From the <a href=\'https://sammlung.belvedere.at/objects/7948/der-hafen-granatello-bei-portici-mit-dem-vesuv-im-hintergrun\'>Belvedere</a>.',
  [rat]:
    '<img src="images/514641ldsdl.jpg" class="center" title="Das Rathaus in Gmunden" width="400"> (1860) by Rudolf von Alt <br><br> From the <a href=\'https://sammlung.belvedere.at/objects/6770/das-rathaus-in-gmunden\'>Belvedere</a>.',
  [rue]:
    '<img src="images/rue.jpg" class="center" title="La rue de Castiglione" width="400"> (1829) by Canella, Giuseppe  <br><br> From the <a href=\'https://www.parismuseescollections.paris.fr/en/node/151547#infos-principales\'>Paris Musées</a>.',
  [cambridge]:
    '<img src="images/cambridge.jpg" class="center" title="King\'s Parade, Cambridge" width="400"> (1798) by Thomas Malton the Younger  <br><br> From the <a href=\'https://collections.britishart.yale.edu/catalog/tms:1534\'>Yale Center for British Art</a>.',
  [rainy]:
    '<img src="images/509407ldsdl.jpg" class="center" title="Rainy Evening on Hennepin Avenue" width="400"> (1902) by Robert Koehler  <br><br> From the <a href=\'https://collections.artsmia.org/art/303/rainy-evening-on-hennepin-avenue-robert-koehler\'>Minneapolis Institute of Art</a>.',
  [haarlem]:
    '<img src="images/haarlem.jpeg" class="center" title="Haarlem City hall with figures on the Grote markt" width="400"> (1671) by Gerrit Adriaensz Berckheyde  <br><br> From the <a href=\'https://www.franshalsmuseum.nl/nl/verdiep/collectie/\'>Frans Hals Museum</a>.',
  [brew]:
    '<img src="images/brew.jpg" class="center" title="View of the Bakenessergracht with the Passer-en-Valk Brewery" width="400"> (1662) by Gerrit Berckheyde  <br><br> From the <a href=\'https://www.franshalsmuseum.nl/nl/art/gezicht-op-de-bakenessergracht-met-de-brouwerij-de-passer-en-de-valk/\'>Frans Hals Museum</a>.',
  [grapes]:
    '<img src="images/530688ldsdl.jpg" class="center" title="A Game of Bowls on the Bowling Green Outside the Bunch of Grapes Inn, Hurst, Berkshire" width="400"> (undated 1746–1801) by Michael Angelo Rooker  <br><br> From the <a href=\'https://collections.britishart.yale.edu/catalog/tms:47374\'>Yale Center for British Art</a>.',
  [lviv]:
    '<img src="images/lviv.jpg" class="center" title="Fair before Easter at the Bernardine square in Lviv in 1895" width="400"> (1895) by Tadeusz Rybkowski  <br><br> From the <a href=\'https://cyfrowe.mnw.art.pl/en/catalog/444862\'>National Museum in Warsaw</a>.',
  [plac]:
    '<img src="images/530671ldsdl.jpg" class="center" title="Krasiński Square and the Piarist church" width="400"> (1830) by Marcin Zaleski  <br><br> From the <a href=\'https://cyfrowe.mnw.art.pl/en/catalog/445903\'>National Museum in Warsaw</a>.',
  [myse]:
    '<img src="images/Warsaw.jpg" class="center" title="Myślewicki Palace in Warsaw" width="400"> (c1870) by Marcin Zaleski  <br><br> From the <a href=\'https://cyfrowe.mnw.art.pl/en/catalog/447881\'>National Museum in Warsaw</a>.',
  [amalfi]:
    '<img src="images/KMS8884.jpg" class="center" title="View of the Square in Amalfi" width="400"> (1835) by Martinus Rørbye  <br><br> From the <a href=\'https://open.smk.dk/en/artwork/image/KMS8884\'>Statens Museum for Kunst</a>.',
  [llyon]:
    '<img src="images/505137ldsdl.jpg" class="center" title="Vue du pont de la Guillotière à Lyon" width="400"> (1760) by Jean-Jacques de Boissieu  <br><br> From the <a href=\'https://sammlung.staedelmuseum.de/en/work/vue-du-pont-de-la-guillotiere-a-lyon\'>Städel Museum</a>.',
  [navona]:
    '<img src="images/navona.png" class="center" title="Roman Market Scene in the Piazza Navona" width="400"> (1657) by Johannes Lingelbach <br><br> From the <a href=\'https://sammlung.staedelmuseum.de/en/work/roman-market-scene-in-the-piazza-navona\'>Städel Museum</a>.',
  [asch]:
    '<img src="images/asch.png" class="center" title="View of Aschaffenburg" width="400"> (1786) by Christian Georg Schütz the Elder <br><br> From the <a href=\'https://sammlung.staedelmuseum.de/en/work/view-of-aschaffenburg\'>Städel Museum</a>.',
  [binn]:
    '<img src="images/binn.jpg" class="center" title="View of the Binnenhof, The Hague" width="400"> (1690) by Gerrit Berckheyde <br><br> From the <a href=\'https://www.museothyssen.org/en/collection/artists/berckheyde-gerrit-adriaensz/view-binnenhof-hague\'>Museo Nacional Thyssen-Bornemisza</a>.',
  [bello]:
  ...
  [admiral]:
    '<img src="images/539561ldsdl.jpg" class="center" title="The Admiral House, Simon’s Town, Cape of Good Hope (1844) by Lt. Humphrey John Julian" width="400"> (1844) by Lt. Humphrey John Julian <br><br> From the <a href=\'https://collections.britishart.yale.edu/catalog/tms:10760\'>Yale Center for British Art</a>.',
  [geyser]:
    '<img src="images/531291ldsdl.jpg" class="center" title="The Castle Geyser, Upper Geyser Basin, Yellowstone National Park" width="400"> (1874) by Thomas Moran <br><br> From the <a href=\'https://www.cartermuseum.org/collection/castle-geyser-upper-geyser-basin-yellowstone-national-park-1971592\'>Amon Carter Museum of American Art</a>.',
  [kastel]:
    '<img src="images/542167ldsdl.jpg" class="center" title="View of ‘Kastellet’, Copenhagen" width="400"> (1890) by Johan Rohde <br><br> From the <a href=\'https://emp-web-84.zetcom.ch/eMP/eMuseumPlus?service=ExternalInterface&module=collection&objectId=19757&viewType=detailView\'>National Museum</a>.',
  [akard]:
    '<img src="images/911464absdl.jpg" class="center" title="South Akard Street" width="400"> (1932) by Lloyd Sargent <br><br> From the <a href=\'https://www.dma.org/art/collection/object/3149188\'>Dallas Museum of Art</a>.',
  [roros]:
    '<img src="images/513156ldsdl.jpg" class="center" title="Street in Røros in Winter" width="400"> (1903) by Harald Sohlberg <br><br> From the <a href=\'https://www.nasjonalmuseet.no/en/collection/object/NG.M.00882\'>Nasjonalmuseet Norway</a>.',
  [monet]:
  ...
  [entry]:
    '<img src="images/Charles_Meynier_-_Napoleon_in_Berlin.png" class="center" title="Entry of Napoleon I into Berlin" width="400"> (1810) by Charles Meynier <br><br> From the <a href=\'https://en.chateauversailles.fr/\'>Palace of Versailles</a>.',
  [crownprince]:
